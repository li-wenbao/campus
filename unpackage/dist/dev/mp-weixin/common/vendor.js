...
/***/ 13:
/*!***********************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/utils/utils.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 17:
/*!*******************************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/utils/locationModel.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.Location = void 0;var _config = __webpack_require__(/*! ./config */ 18);function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(n);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
Location = /*#__PURE__*/function () {
  function Location() {_classCallCheck(this, Location);
    this.key = _config.Config.key;
    this.mapUrl = _config.Config.mapUrl;
  }_createClass(Location, [{ key: "getLocation", value: function getLocation(
    callback) {
      var _this = this;
      ...
      uni.getLocation({
        ...
        success: function success(res) {
          ...
          var params = {
            ...
            eCallback: function eCallback(res) {
              callback && callback(res);
            } };
        ...
        fail: function fail() {
          ...
          uni.getSetting({
            success: function success(res) {
              ...
              //解决支付宝小程序兼容性问题
              var userLocationScope = res.authSetting["scope.userLocation"] !== undefined ? res.authSetting["scope.userLocation"] : res.authSetting["location"];
    ...
    params) {
      ...
      then(function (data) {
        ...
        if (error == null) {
          var formattedAddress = res.data.regeocode.formatted_address;
          var addressComponent = res.data.regeocode.addressComponent;
          var city = addressComponent.city;
          var aois = res.data.regeocode.aois;
          ...
          if (aois.length > 0) {
            ...
            //解决定位不精确问题
            location = params.longitude + "," + params.latitude;
            var baseAddress = addressComponent.province + addressComponent.city;
          ...
          params.sCallback && params.sCallback(_data2);
        } else {
          var _data3 = {
            locationError: true };

          params.eCallback && params.eCallback(_data3);
        }
      });
    } }]);return Location;}();exports.Location = Location;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 18:
/*!************************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/utils/config.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.Config = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var Config =
function Config() {_classCallCheck(this, Config);

};exports.Config = Config;

Config.key = '7b08519b13cab78fcd0014bfdcd324a9';
Config.mapUrl = "https://restapi.amap.com/v3/geocode/regeo";

/***/ }),

/***/ 19:
/*!***********************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/store/store.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 20:
/*!*********************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/utils/api.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _uniFly = _interopRequireDefault(__webpack_require__(/*! ../utils/uniFly.js */ 21));



var _utils = _interopRequireDefault(__webpack_require__(/*! ../utils/utils.js */ 13));
var _store = _interopRequireDefault(__webpack_require__(/*! ../store/store.js */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // var Fly=require("flyio/dist/npm/wx")
// var uniFly=new Fly
//基础路由
...
/***/ 21:
/*!************************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/utils/uniFly.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 28:
/*!****************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/json.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var storelist = [{
  "id": 1,
  "name": "豚骨拉面(怡园风味)",
  "url": "/static/ddd.jpg",
  "grade": 4.9,
...
var cuiconlist = [{
  "url": "/static/list/cate.png",
  "name": "校园美食" },

{
  "url": "/static/list/lunch.png",
  "name": "美味午餐" },

{
  "url": "/static/list/drinks.png",
  "name": "甜点饮品" },

{
  "url": "/static/list/fruit.png",
  "name": "新鲜水果" },

{
  "url": "/static/list/supermarket.png",
  "name": "校园超市" },

{
  "url": "/static/list/run.png",
  "name": "校内跑腿" },

{
  "url": "/static/list/snack.png",
  "name": "快食简餐" },

{
  "url": "/static/list/breakfast.png",
  "name": "美味早餐" }];
...

{
  ...
  catelist: catelist,
  goods: goods,
  orderList: orderList };exports.default = _default;

/***/ }),

/***/ 29:
/*!*******************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/api/api.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.publicing = exports.listing = void 0;



var _errdata = __webpack_require__(/*! api/errdata.js */ 30); // 封装请求：get post
// 面向对象es6 promise  等等。。。
// 引进提示
// GET
...
/***/ 30:
/*!***********************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/api/errdata.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.errdata = void 0; // 提示
var errdata = {
...
/***/ 31:
/*!***********************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/api/request.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.commenturl = exports.wxpayingurl = exports.wxloginurl = exports.getdishesurl = exports.shopurl = exports.discussurl = exports.searchurl = exports.multipleurl = exports.startingurl = exports.wxshopurl = exports.getpreferurl = void 0; // 公用地址
var url = 'http://meituan.thexxdd.cn/api/';
...
// 提交评论
exports.wxpayingurl = wxpayingurl;var commenturl = "".concat(url, "message/comment");exports.commenturl = commenturl;

/***/ }),

/***/ 4:
/*!*******************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 7:
/*!************************************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/pages.json?{"type":"style"} ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "" }, "pages/order/order": {}, "pages/user/user": {}, "pages/takeout/takeout": { "navigationBarTitleText": "下单", "navigationBarBackgroundColor": "#ffd300" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "ld-shop", "navigationBarBackgroundColor": "#007AFF", "backgroundColor": "#F8F8F8", "navigationStyle": "custom" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!***********************************************************************!*\
  !*** D:/用户目录/我的文档/HBuilderProjects/campus/pages.json?{"type":"stat"} ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
