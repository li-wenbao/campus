<template>
	<view>
		<view class="prefer-posi bg-white align-center border-bottom">
			<!-- 筛选区 -->
			<view class="delica-view flex align-center">
				<view class="flex align-center" @tap="multiple()">
					<text>{{synthesize}}</text>
					<image src="../../../static/coen/paixu.png" 
					mode="widthFix"></image>
				</view>
				<view class="delica-grow" @click="saLes()">销量最高</view>
				<view class="delica-grow" @click="saLes()">起送价最低</view>
				<view class="delica-grow" @click="saLes()">津贴联盟</view>
				<view class="delica-list justify-end" @click="scReen()">
					<text>筛选</text>
